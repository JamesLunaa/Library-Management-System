<div id="user-sidebar" class="card cardBorder d-flex flex-column flex-shrink-0"
    ...
    <div class="card-body border-end border-secondary">
        ...
        <ul class="fs-5 nav nav-pills flex-column mb-auto vh-100">
            <li class="nav-item">
                <a href="{{ route('instructor.rules') }}"
                    class="nav-link {{ Route::currentRouteName() == 'instructor.rules' ? 'active' : '' }} text-white"
                    aria-current="page">
            ...
            <li class="nav-item">
                <a href="{{ route('instructor.searchBook') }}"
                    class="nav-link {{ Route::currentRouteName() == 'instructor.searchBook' || Route::currentRouteName() == 'instructorBorrow' ? 'active' : '' }} text-white"
                    aria-current="page">
